	...
	if(isset($_POST["line"]))
	{
		...
		if(mysqli_num_rows($result)<>0)
		{
			...
			if($row['enabled']==0)
			{
				...
				<a href='enable.php?tbl=tbl_lines&col=id&val=" . $row['id'] . "' title='Undelete'>
				[Undelete Line]
				</a>
				</td>
				</tr>
                ...
                <?php
					...
					for($j=1;$row=mysqli_fetch_array($result);$j++)
					{
						...
						echo "<tr style='background-color:" .  $color . ";'>
								<td>" . $row['line'] . "</td>
								<td align='center'><a href='disable.php?" . $get_info . "' title='Delete " . $row['line'] . "'><img src='..\images\delete.png' /></a></td>
							  </tr>";
					}				
				?>
        	<tr>
