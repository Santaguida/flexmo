	...
	if(isset($_POST["model"]))
	{
		...
		if(mysqli_num_rows($result)<>0)
		{
			...
			if($row['enabled']==0)
			{
				...
				<a href='undelete.php?tbl=tbl_ict_machine_models&col=id&val=" . $row['id'] . "' title='Undelete'>
				[Undelete Model]
				</a>
				</td>
				</tr>
                ...
                <?php
					...
					for($j=1;$row=mysqli_fetch_array($result);$j++)
					{
						...
						echo "<tr style='background-color:" .  $color . ";'>
								<td>" . $row['model'] . "</td>
								<td align='center'><a href='delete.php?" . $get_info . "' title='Delete " . $row['model'] . "'><img src='..\images\delete.png' /></a></td>
							  </tr>";
					}				
				?>
        	<tr>
